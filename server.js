...
// Prefer Railway's mounted volume path so uploads survive redeploys.
const UPLOAD_DIR = process.env.RAILWAY_VOLUME_MOUNT_PATH || path.join(__dirname, "public", "uploads");
